...
- [firebase_auth: ^4.18.0 - auth](https://pub.dev/packages/firebase_auth)
- [google_sign_in: ^6.2.1 - login](https://pub.dev/packages/google_sign_in)
- [change_app_package_name: ^1.1.0 - rename](https://pub.dev/packages/change_app_package_name)
